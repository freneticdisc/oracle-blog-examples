...
# Set to 1 to copy all files of type owner to a new owner file
# This action causes a new checkin to occur for each owner file being copied
# By default, the copy of an owner file is a "soft" file that points to the source document
binder.putLocal("copyOwnerFilesToNewFiles", "0")

# Set to 1 to create new content items for all soft files being copied
# By default, a copy of a soft file is another soft file pointing to the same content item
binder.putLocal("copySoftFilesToNewFiles", "1")
